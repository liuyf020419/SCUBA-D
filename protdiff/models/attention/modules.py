...
class EDTransformerLayer(nn.Module):
    """Transformer layer block."""
    ...
    def _init_submodules(self, add_bias_kv, use_esm1b_layer_norm):
        ...
        self.cross_attn_layer_norm = BertLayerNorm(self.embed_dim)
    ...
    def forward(
        self, x, memory, self_attn_mask=None, self_attn_padding_mask=None, 
        cross_attn_mask=None, cross_attn_padding_mask=None, 
...
class SinusoidalPositionalEmbedding(nn.Module):
    def __init__(self, embed_dim, padding_idx=0, learned=False):
        super().__init__()
        self.embed_dim = embed_dim
